    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {availableModels.map((model) => {
          ...
          const isDisabled = maxSelections && !isSelected && selectedModels.length >= maxSelections;
              ...
              <div className="flex items-start space-x-2">
                <IconComponent 
                  ...
                  className={`mt-0.5 flex-shrink-0 ${
                    isSelected ? "text-blue-400" : isDisabled ? "text-slate-500" : "text-slate-400"
                  }`} 
                />
                <div className="flex-1 min-w-0">
                  ...
                  <span
                    className={`inline-block px-1 py-0.5 text-xs rounded text-xs ${
